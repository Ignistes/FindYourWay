...
//		System.out.println(capDeg(latVectAr, longVectAr, latInterRSetRF(latXInterRSetRF(latXVectAr, longYVectAr, latXA, longYA, latXB, longYB, distanceRS), longYInterRSetRF(latXVectAr, longYVectAr, latXA, longYA, latXB, longYB, distanceRS, latXInterRSetRF(latXVectAr, longYVectAr, latXA, longYA, latXB, longYB, distanceRS))), longInterRSetRF(latXInterRSetRF(latXVectAr, longYVectAr, latXA, longYA, latXB, longYB, distanceRS), longYInterRSetRF(latXVectAr, longYVectAr, latXA, longYA, latXB, longYB, distanceRS, latXInterRSetRF(latXVectAr, longYVectAr, latXA, longYA, latXB, longYB, distanceRS)))));
	...
	/**
	 * 
	 * @param latA : latitude en coordonn�es gps d'un point A
	 * @param longA : longitude en coordonn�es gps d'un point A
	 * @param latB : latitude en coordonn�es gps d'un point B
	 * @param longB : longitude en coordonn�es gps d'un point B
	...
	/**
	 * 
	 * @param latDe : latitude en coordonn�es g�ographiques du point de d�part
	 * @param longDe : longitude en coordonn�es g�ographiques du point de d�part
	 * @param latAr : latitude en coordonn�es g�ographiques du point d'arriv�e
	 * @param longAr : longitude en coordonn�es g�ographiques du point d'arriv�e
	...
	/**
	 * 
	 * @param latx : latitude en coordonn�e x,y du point d'arriv�e du vecteur courant
	 * @param longy : longitude en coordonn�e x,y du point d'arriv�e du vecteur courant
	 * @param rayon : distance de la RS = vitesse du bateau (1h)
	 * @param coeffDir : coefficient directeur de la droite (AB)
	 * @param ordOrig : ordonn�e � l'origine de la droite (AB)
	 * @return premi�re solution x de l'intersection entre le cercle, de rayon �gal � la distance RS, et la droite (AB)
	 */
	 ...
	 * @param coeffDir : coefficient directeur de la droite (AB)
	 * @param ordOrig : ordonn�e � l'origine de la droite (AB)
	 * @return deuxi�me solution x de l'intersection entre le cercle, de rayon �gal � la distance RS, et la droite (AB)
	 */
	...
	/**
	 * 
	 * @param xUn : premi�re solution x de l'intersection entre un cercle et une droite
	 * @param xDeux : deuxi�me solution x de l'intersection entre un cercle et une droite
	 * @param xA : coordonn�e x du point de d�part du bateau
	 * @param xB : coordonn�e x du point d'arriv�e du bateau
	...
	/**
	 * 
	 * @param latXVectAr : latitude en coordonn�es x,y du point d'arriv�e du vecteur courant
	 * @param longYVectAr : longitude en coordonn�es x,y du point d'arriv�e du vecteur courant
	 * @param latXA : latitude en coordonn�es x,y du point de d�part du bateau
	 * @param longYA : longitude en coordonn�es x,y du point de d�part du bateau
	 * @param latXB : latitude en coordonn�es x,y du point d'arriv�e du bateau
	 * @param longYB : longitude en coordonn�es x,y du point d'arriv�e du bateau
	 * @param distanceRS : distance de la RS = vitesse du bateau (pour 1h)
	 * @return latitude en coordonn�es x,y du point d'intersection entre la RS et la RF
	 */
	 ...
	 * @param longYB : longitude en coordonn�es x,y du point d'arriv�e du bateau
	 * @param distanceRS : distance de la RS = vitesse du bateau (pour 1h)
	 * @param latX : latitude en coordonn�es x,y du point d'intersection entre la RS et la RF
	 * @return longitude en coordonn�es x,y du point d'intersection entre la RS et la RF
	 */
	 ...
	 * 
	 * @param latX : latitude, en coordonn�es x,y, du point d'intersection entre la RS et la RF 
	 * @param longY : longitude, en coordonn�es x,y, du point d'intersection entre la RS et la RF
	 * @return latitude, en coordonn�es g�ographiques, du point d'intersection entre la RS et la RF
	 */
	 ...
	 * @param latX : latitude, en coordonn�es x,y, du point d'intersection entre la RS et la RF 
	 * @param longY : longitude, en coordonn�es x,y, du point d'intersection entre la RS et la RF
	 * @return longitude, en coordonn�es g�ographiques, du point d'intersection entre la RS et la RF
	 */
	...
	/**
	@param latVectAr : latitude en coordonn�es g�ographiques du point d'arriv�e du vecteur courant
	 * @param longVectAr : longitude en coordonn�es g�ographiques du point d'arriv�e du vecteur courant
	 * @param latXVectAr : latitude en coordonn�es x,y du point d'arriv�e du vecteur courant
	 * @param longYVectAr : longitude en coordonn�es x,y du point d'arriv�e du vecteur courant
	 * @param latXA : latitude en coordonn�es x,y du point de d�part du bateau
	 * @param longYA : longitude en coordonn�es x,y du point de d�part du bateau
	...
	/**
	 * @return : le tableau de type double,double de la liste des caps pour les 4 ports les plus proches du point de d�part du bateau
	 */
	...
	/**
	 * 
	 * @return : le tableau des caps pour le port le plus rapide � atteindre
	 */
	...
	/**
	 * 
	 * @return : un tableau de type double qui retourne toutes les distances en miles nautiques entre les diff�rents caps � prendre pour le port d'indice z�ro
	 */
	...
	/**
	 * 
	 * @return : un tableau de type double qui retourne toutes les distances en miles nautiques entre les diff�rents caps � prendre pour le port d'indice un
	 */
	...
	/**
	 * 
	 * @return : un tableau de type double qui retourne toutes les distances en miles nautiques entre les diff�rents caps � prendre pour le port d'indice deux
	 */
	...
	/**
	 * 
	 * @return : un tableau de type double qui retourne toutes les distances en miles nautiques entre les diff�rents caps � prendre pour le port d'indice trois
	 */
	...
	/**
	 * @return : le tableau des quatre ports o� leur distance, qui les s�parent avec le point du d�part du bateau, est la plus courte par rapport aux autres ports
	 */
	...
	/**
	 * @return : un tableau de type Point avec les points des ports en coordonn�es Breizh (les points B)
	 */
